...
const STEPS: Step[] = [
    {
        id: "naming",
        run: ({ ctx, files }) =>
            runNamingStep({ ctx, trackedFiles: files, enabled: false }),
    },
    {
        id: "node",
    ...
    {
        id: "shell",
        run: ({ ctx, files }) => runShellStep({ ctx, trackedFiles: files }),
    },
    ...
    {
        id: "workflow",
        run: ({ ctx, files }) => runWorkflowStep({ ctx, trackedFiles: files }),
    },
    {
        id: "tofu",
        run: ({ ctx, files }) => runTofuStep({ ctx, trackedFiles: files }),
    },
];
